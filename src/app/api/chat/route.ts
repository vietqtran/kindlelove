...
export async function POST(request: NextRequest) {
   ...
   },
   {
      ...
      category: 5
                        ...
                        Đây là đoạn prompt tôi gắn vào api để gọi nên hãy chỉ trả lời khách hàng thôi, không trả lời gì thêm và chỉ trả lời dưới format text (không được chứa markdown hay html) vì tôi render câu trả lời bằng string.
